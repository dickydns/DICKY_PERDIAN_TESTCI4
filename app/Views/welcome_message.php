...
<section class="d-flex justify-content-center align-items-center ">
    ...
    <div class="card shadow-lg p-4 rounded-4" style="width: 100%; max-width: 420px;">
        ...
        <form action="<?= site_url('submit_guest') ?>" method="POST">
            <div class="mb-3">
                <label for="nama" class="form-label">Nama Lengkap</label>
                <input type="text" minlength="5" maxlength="30" class="form-control" id="nama" name="name" placeholder="Masukkan nama Anda" required>
            </div>

            <div class="mb-3">
                <label for="email" class="form-label">Alamat Email</label>
                <input type="email"  minlength="5" maxlength="100"  class="form-control" id="email" name="email" placeholder="Contoh@mail.com" required>
            </div>

            <div class="mb-3">
                <label for="pesan" class="form-label">Pesan</label>
                <textarea class="form-control" id="pesan" name="message" rows="3" placeholder="Tuliskan pesan Anda..." required></textarea>
            </div>
            <br/>
            ...
            <br/>
            <div class="d-grid">
                <button type="submit" class="btn  btn-lg text-white" style="background:rgba(221, 72, 20, .8);">Kirim</button>
            </div>
        </form>
    </div>

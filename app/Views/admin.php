...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= site_url('/list') ?>" >Admin</a></li>
...
<section class="d-flex justify-content-center align-items-center ">
    ...
    <div class="card shadow-lg p-4 rounded-4" style="width: 100%"; >
        <h3 class="text-center mb-4 text-dark">Buku Tamu</h3>
        <form action="<?= site_url('/list') ?>" method="GET">
            <div class="row">
                <div class="col-lg-3">
                    <div class="form-group">
                        <label for="">Dari tanggal</label>
                        <input type="date" name="start" value="<?= $start ?? '' ?>" class="form-control mt-2" required>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
                        <label for="">Ke tanggal</label>
                        <input type="date" name="end" value="<?= $end ?? '' ?>" class="form-control mt-2" required>
                    </div>
                </div>
                <div class="col-lg-2 ">
                    <div class="form-group d-grid gap-2">
                        <label for="">Ke tanggal</label>
                        <input type="submit" class="btn btn-secondary text-white "  value="Filter">
                    </div>
                </div>
                <div class="col-lg-1 ">
                    <div class="form-group d-grid gap-2">
                        <label for="">Reset</label>
                        <a href="<?= site_url('/list') ?>" class="btn btn-secondary text-white d-grid gap-2 "  value="Filter">Reset</a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <label for="">Export</label><br/>
                    <a href="<?= site_url('export') ?>?start=<?= $start ?? '' ?>&end=<?= $end ?? '' ?>" target="_blank" class="btn btn-secondary text-white d-grid gap-2 mt-2"  value="Filter">Export</a>
                </div>
            </div>
        </form>
        <br/>
